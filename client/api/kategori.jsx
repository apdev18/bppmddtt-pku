...
export const Create = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (!formData.categoryName) {
            ...
            try {
                const { data } = await axios.post(baseUrl + '/api/kategori/tambah', {
                    ...formData
...
export const Update = (formData) => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (!updateData.categoryName) {
            ...
            try {
                const { data } = await axios.patch(baseUrl + '/api/kategori', {
                    ...updateData
                }, {
                    withCredentials: true,
                    headers
...
export const Delete = (id) => {
    ...
    const handleDelete = async (event) => {
        ...
        try {
            const { data } = await axios.delete(baseUrl + '/api/kategori', {
                data: { id: categoryId },
                headers
            });
            if (data) {
