...
import { Create, Delete, List, Update } from "../../api/departemen";
                ...
                <div class="mb-9">
                    ...
                    <div class="row">
                                    ...
                                    <table class="table fs--1 mb-0">
                                        ...
                                        <tbody class="list" id="table-latest-review-body">
                                            {currentItems.length === 0 ?
                                                <tr>
                                                    <td colSpan={5} class="text-center">Department tidak ditemukan</td>
                                                </tr>
                                                                    ...
                                                                    <div class="modal-dialog modal-dialog-centered">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="verticallyCenteredModalLabel">Edit department</h5>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <div class="g-3 mb-3 mt-3">
                                                                                    <div class="form-floating mb-3">
                                                                                        ...
                                                                                        />
                                                                                        <label for="floatingInputGrid">Nama Department</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                                ...
                                                                                <div class="col-12 col-md-auto">
                                                                                    <div class="d-flex align-items-center">
                                                                                        ...
                                                                                        <div class="ms-3" id="deleteDes">
                                                                                            ...
                                                                                            <p class="text-600 fs--1 mb-3">Apakah anda yakin menghapus department? Semua data akan <br />
                        ...
                        <div class="col-xl-4 card">
                            <div class="card-body">
                                <h4 class="card-title">Tambah department baru</h4>
                                <Create />
                            </div>
                        </div>
                    </div>
